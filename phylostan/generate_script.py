...
def get_model(params):
    ...
    if params.clock is not None:
        ...
        if params.coalescent == 'constant':
            ...
            if params.heterochronous:
                model_priors.append('heights ~ integrated_constant_coalescent(1000.0, map, lowers);') # picking u = 1E3
            else:
                model_priors.append('heights ~ integrated_constant_coalescent(1000.0, map);')
